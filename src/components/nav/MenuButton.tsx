import { createSignal, Show, createEffect, onCleanup, batch, type Component } from "solid-js";
...
const MenuButton: Component = () => {
  ...
  // Local state
  const [externalTrigger, setExternalTrigger] = createSignal<TriggerState>(null);
