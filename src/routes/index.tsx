  ...
  return (
    <main>
      ...
      <section class="hero h-[100svh] flex items-center justify-center relative text-light-white">
        ...
        <h1
          class="font-formula-bold leading-none absolute bottom-[25%] md:landscape:bottom-[25%] xl:landscape:bottom-[20%] text-[clamp(1.5rem,15vw,6rem)] sm:landscape:text-[clamp(2rem,10vw,10rem)] lg:landscape:text-[clamp(2rem,10vw,10rem)] 2xl:text-[10rem] text-center"
