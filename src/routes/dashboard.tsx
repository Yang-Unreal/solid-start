...
import { UserCircle, Loader2 } from "lucide-solid";
  ...
  const DashboardContent = () => {
    ...
    return (
      <div class="flex">
        ...
        />
        <div class="flex-grow bg-neutral-100 text-slate-800 min-h-screen ml-64 relative">
          <main class="w-full max-w-none px-4 sm:px-6 lg:px-8 py-4 sm:py-6  flex flex-col grow overflow-hidden">
            <div class="flex flex-col h-full">
              <Show when={activeContent() === "user"}>
                <Show
                  when={!sessionSignal().isPending}
                  fallback={
                    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-neutral-700 flex flex-col items-center justify-center">
                      <Loader2
                        size={48}
                        class="animate-spin text-neutral-500 mb-4"
                      />
